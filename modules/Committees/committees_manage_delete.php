...
if (isActionAccessible($guid, $connection2, '/modules/Committees/committees_manage_delete.php') == false) {
    ...
    $form = DeleteForm::createForm($session->get('absoluteURL').'/modules/Committees/committees_manage_deleteProcess.php?committeesCommitteeID='.$committeesCommitteeID, true);
    echo $form->getOutput();
}
