...
class TcpdfRenderer implements ReportRendererInterface
{
    ...
    {
        $this->pdf = new ReportTCPDF($this->template->getData('orientation', 'P'), 'mm', strtoupper($this->template->getData('pageSize', 'A4')) == 'LETTER' ? 'LETTER' : (strtoupper($this->template->getData('pageSize', 'A4')) == 'LEGAL' ?  [215.9, 355.6] : 'A4') , true, 'UTF-8', false);
